...
SVM é intrinsicamente uma técnica para classificação binária, entretanto pode facilmente ser convertida para classificar um dado entre mais de duas classes. A seguir, serão apresentadas técnicas usadas para obter essa funcionalidade. Para as sessões seguintes, esses serão os dados usados para exemplo.
...
Onde $C$ é o número de classes do problema. Assim, no caso exemplo, serão geradas 6 partições de dados. Para cada uma dessas partições será gerada uma SVM. Um exemplo é mostrado a seguir.
